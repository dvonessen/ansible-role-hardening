...
| `hardening_login_issue`                | Banner message. See (defaults/main.yml)[defaults/main.yml] | Fulltext message for `/etc/issue`.                                      |
| `hardening_login_motd`                 |                  `hardening_login_issue`                   | Fulltext message for `/etc/motd`.                                       |
